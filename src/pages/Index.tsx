          ...
          {!isChatFocused && <div className="flex-1 flex items-center justify-center px-8">
              <div className="flex flex-col items-center w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 w-full">
                  {suggestedActions.map((action, index) => <Card key={index} className={`hover:shadow-lg transition-all duration-200 cursor-pointer ${action.backgroundColor} ${action.borderColor} border-2 hover:scale-105`} onClick={action.onClick}>
