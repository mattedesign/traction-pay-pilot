...
const RouteOptimization = () => {
  ...
  return (
    <Card className="bg-slate-50 border-slate-200 relative overflow-hidden">
      ...
      <div className="absolute top-2 right-2 w-32 h-20 opacity-15">
        <svg viewBox="0 0 128 80" className="w-full h-full">
          ...
          />
          {/* Start point */}
          <circle cx="10" cy="40" r="3" className="fill-blue-500" />
          {/* End point */}
          <circle cx="118" cy="40" r="3" className="fill-blue-500" />
          {/* Fuel stops */}
          ...
          {/* Traffic indicators */}
          <rect x="30" y="38" width="8" height="4" rx="2" className="fill-red-300 opacity-60" />
          <rect x="70" y="38" width="12" height="4" rx="2" className="fill-green-300 opacity-60" />
        </svg>
      </div>
      ...
      <CardHeader className="relative z-10">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <CardTitle className="text-slate-900">Smart Route Planning</CardTitle>
      ...
      <CardContent className="space-y-4 relative z-10">
        <div className="bg-white border border-slate-200 rounded-lg p-4">
          <div className="flex justify-between items-center mb-3">
            <div className="flex items-center space-x-2">
              <span className="font-medium text-slate-900">Recommended Route</span>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white border border-slate-200 rounded-lg p-4 text-center">
            ...
            <p className="text-sm font-medium text-slate-900">Fuel Cost</p>
            <p className="text-xl font-bold text-emerald-600">$52.30</p>
          ...
          <div className="bg-white border border-slate-200 rounded-lg p-4 text-center">
            ...
            <p className="text-sm font-medium text-slate-900">Drive Time</p>
            <p className="text-xl font-bold text-blue-600">1h 15m</p>
            <p className="text-xs text-slate-500">fastest route</p>
          </div>
        </div>

        <Button className="w-full bg-blue-600 hover:bg-blue-700 font-medium" onClick={handleViewRoute}>
